...
<body>
    <div align="center">
        <h4>PRIMER PARCIAL TEM-742</h4><hr>
        <h4>ESTUDIANTE: WILSON SANTOS QUISPE ZABALA</h4><hr>
        <h4>CI: 11070598 LP</h4><hr>
        <div class="form-group" style="position: relative; margin: auto; width: 500px;">
            <form method="POST" action="#" name="formulario">
                <input type="text" name="txtCodigo" value="" size="30" placeholder="ID"
                       class="form-control"/> 
                 <input type="text" name="txtNombre" value="" size="30" placeholder="Descripcion"
                       class="form-control"/>
                 <input type="text-area"  name="txtDescripcion" value="" size="30" placeholder="Categoria"
                       class="form-control"/>
